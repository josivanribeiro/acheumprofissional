package br.com.acheumprofissional.log4j;
...
public class Log4jInit extends HttpServlet {
	...
	private static final String LOG4J_FILE = "acheumprofissional_log4j.properties";
	static Logger logger = Logger.getLogger (Log4jInit.class.getName());
	
	public void init() {
		String prefix =  getServletContext().getRealPath("/");
		prefix = prefix.replace("acheumprofissional/", "config/");
